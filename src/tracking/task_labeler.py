...
class TaskAnalysisEvent:
    """TaskEvent já preparado para análise e métricas."""
...
class TaskLabeler:
    """Atribui nomes/categorias de análise sem alterar a lógica de tracking."""
    ...
    def label(self, event: TaskEvent) -> TaskAnalysisEvent:
        """Devolve o evento com o nome usado em métricas, Excel e dashboard."""
    ...
    def _unattributed_assembly_label(self) -> str:
        return f"{self._assembly_zone} sem peça"
